...
func (app *Config) authenticate(w http.ResponseWriter, a AuthPayload) {
	// create some json will send to the auth service
	...
	// make sure we get back the correst status code
	...
	// create a variable we will read reponse.Body into
